...
return}throw"Unable to print message: "+String(a)}}],["","my_app.dart",,K,{
"^":"",
Iq:[function(){var z=document.querySelector("#sample_text_id")
z.textContent="Click me!"
z=J.Vg(z)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(K.EB()),z.Sg),[H.Kp(z,0)]).Zz()},"$0","eE",0,0,1],
qd:[function(a){var z,y,x,w
z=document.querySelector("#sample_text_id").textContent
y=P.p9("")
for(x=z.length-1;x>=0;--x){w=z[x]
y.vM+=w}document.querySelector("#sample_text_id").textContent=y.vM},"$1","EB",2,0,9]},1],])
...
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"a5",void:true,args:[W.Aj]},{func:"NT"},{func:"aB",args:[null]},{func:"zx",args:[P.qU]},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:P.qU,args:[P.KN]},];$=null
